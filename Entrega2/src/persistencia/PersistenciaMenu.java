...
public class PersistenciaMenu {
    ...
    public void cargarMenu(Cafe cafe, String archivo) throws IOException {
    ...
    public void salvarMenu(Cafe cafe, JSONObject jobject, String archivo) throws IOException {
